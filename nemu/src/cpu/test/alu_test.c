...
void alu_test_add() {
	...
	int input[] = {-2147483648, 2147483647, 0x10000000, -3, -2, -1, 0, 1, 2, 3};
...
void alu_test_shl() {
	...
	uint32_t inputa[] = {-2147483648, 2147483647, 0xffffffff, 0x0, 0x10101010, -3, -2, -1, 0, 1, 2, 3};
...
void alu_test_imul() {
	...
	//TEST_EFLAGS test_eflags;
	int input[] = {-2147483648, 2147483647, 0x0, 0x10101010, -4,-3, -2, -1, 0, 1, 2, 3, 4, 0x0fffffff, 0xefffffff};
	int n = sizeof(input) / sizeof(int);
	int i, j;
	for(i = 0 ; i < n ; i++) {
		for(j = 0 ; j < n ; j++) {
